...
export interface IngestResult {
  ...
  warnings?: string[];
  post_processing_stats?: Array<{ processor_name: string; edges_created?: number }>;
  duration?: number;
}
...
// uploadScan POSTs a collector JSON file to /api/v1/ingest. The file is
// read as text via FileReader and posted as the raw request body with
// Content-Type: application/json (matches the existing handler contract).
