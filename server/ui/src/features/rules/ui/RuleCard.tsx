...
import { severityColor, NODE_KIND_COLORS, CHART_THEME } from "@shared/theme/tokens";
...
export function RuleCard({ rule, isExpanded, onToggle }: RuleCardProps) {
  ...
  const collectorColor = COLLECTOR_COLOR[rule.collector] ?? CHART_THEME.axis;
